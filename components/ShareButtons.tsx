...
export default function ShareButtons({ title, slug, variant = 'inline' }: ShareButtonsProps) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center', justifyContent: variant === 'bar' ? 'center' : 'flex-start' }}>
        {variant === 'bar' && (
      ...
      {copied && (
        <div style={{
          ...
          ✅ लिंक कॉपी हो गया! Instagram स्टोरी में शेयर करें
        </div>
      )}
    </div>
  );
