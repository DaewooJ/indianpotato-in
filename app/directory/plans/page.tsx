...
export const metadata: Metadata = {
  ...
  description: 'Indian Potato डायरेक्टरी में अपना व्यवसाय सूचीबद्ध करें। Basic (निःशुल्क), Silver (₹4,999/वर्ष), Gold (₹7,999/वर्ष), Platinum (₹9,999/वर्ष) — भारत के सबसे बड़े आलू उद्योग प्लेटफ़ॉर्म पर।',
  openGraph: {
    title: 'डायरेक्टरी लिस्टिंग प्लान — Indian Potato',
    description: 'अपना व्यवसाय भारत के #1 आलू प्लेटफ़ॉर्म पर सूचीबद्ध करें',
    type: 'website',
    url: 'https://indianpotato.in/directory/plans',
  },
...
const plans = [
  {
    ...
    badgeBg: '',
    icon: '📋',
    cta: 'निःशुल्क लिस्टिंग',
    ctaBg: 'bg-stone-800 hover:bg-stone-900',
    features: {
      companyName: true,
      location: true,
      phone: true,
  ...
  },
  {
    ...
    badge: '👑',
    badgeBg: 'bg-gradient-to-r from-amber-200 to-yellow-200 text-amber-900',
    icon: '👑',
    cta: 'Gold चुनें — लोकप्रिय',
    ctaBg: 'bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700',
    popular: true,
    features: {
      companyName: true,
      location: true,
  ...
  },
  {
    ...
    badge: '💎',
    badgeBg: 'bg-gradient-to-r from-violet-200 to-purple-200 text-violet-900',
    icon: '💎',
    cta: 'Platinum चुनें',
...
const comparisonRows: { label: string; labelEn: string; key: string; type: 'boolean' | 'text' }[] = [
  ...
  { label: 'विवरण (शब्द)', labelEn: 'Description', key: 'descriptionWords', type: 'text' },
  ...
  { label: 'किस्में / उत्पाद सूची', labelEn: 'Varieties / Products List', key: 'varieties', type: 'boolean' },
  ...
  { label: 'SEO ऑप्टिमाइज़्ड पेज', labelEn: 'SEO Optimized Page', key: 'seoOptimized', type: 'boolean' },
  { label: '👑 प्रीमियम बैज', labelEn: 'Premium Verified Badge', key: 'premiumBadge', type: 'boolean' },
  { label: '⭐ होमपेज पर फ़ीचर्ड', labelEn: 'Featured on Homepage', key: 'featuredHomepage', type: 'boolean' },
  { label: '⭐ श्रेणी में टॉप पर', labelEn: 'Featured in Category', key: 'featuredCategory', type: 'boolean' },
  ...
  return (
    <>
      ...
      <main className="pt-[76px]">
                ...
                <div key={plan.id} className={'relative rounded-2xl border-2 overflow-hidden transition-all ' + plan.border + (plan.popular ? ' ring-2 ring-amber-400 ring-offset-2 scale-[1.02] lg:scale-105' : '')}>
                  ...
                  {plan.popular && (
                    <div className="bg-gradient-to-r from-amber-500 to-orange-500 py-1.5 text-center">
                      <span className="text-[0.7rem] font-bold text-white tracking-wider uppercase">⭐ सबसे लोकप्रिय — MOST POPULAR</span>
                    </div>
                  )}
                  ...
                  <div className={'bg-gradient-to-b ' + plan.gradient + ' p-5 md:p-6'}>
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      {plan.badge && plan.badgeBg && (
                        <span className={'ml-auto text-[0.6rem] font-bold px-2 py-0.5 rounded-full ' + plan.badgeBg}>{plan.badge}</span>
                      )}
                    </div>
                    ...
                    <div className="mb-5">
                      ...
                      {plan.id !== 'basic' && (
                        <p className="font-body text-[0.68rem] text-stone-400 mt-0.5">+ GST | वार्षिक नवीकरण</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2 mb-6">
                      {plan.id === 'basic' && (
                        <>
                          <Feature text="कंपनी का नाम और पता" />
                          <Feature text="फ़ोन नंबर" />
                          <Feature text="श्रेणी में सूचीबद्ध" />
                          <FeatureNo text="कोई प्रोफ़ाइल पेज नहीं" />
                          <FeatureNo text="कोई लोगो या फ़ोटो नहीं" />
                        </>
                      )}
                      {plan.id === 'silver' && (
                        <>
                          <Feature text="समर्पित प्रोफ़ाइल पेज" />
                          <Feature text="कंपनी लोगो + 3 फ़ोटो" />
                          <Feature text="100 शब्दों का विवरण" />
                          <Feature text="📞 कॉल + 💬 WhatsApp बटन" />
                          <Feature text="SEO ऑप्टिमाइज़्ड पेज" />
                        </>
                      )}
                      {plan.id === 'gold' && (
                        <>
                          <Feature text="👑 प्रीमियम सत्यापित बैज" highlight />
                          <Feature text="⭐ होमपेज + श्रेणी में फ़ीचर्ड" highlight />
                          <Feature text="लोगो + 8 फ़ोटो + किस्में सूची" />
                          <Feature text="300 शब्दों का विवरण" />
                          <Feature text="📊 व्यू एनालिटिक्स" />
                          <Feature text="सोशल मीडिया लिंक" />
                        </>
                      )}
                      {plan.id === 'platinum' && (
                        <>
                          <Feature text="💎 सर्वोच्च प्राथमिकता प्लेसमेंट" highlight />
                          <Feature text="Gold की सभी सुविधाएँ शामिल" />
                          <Feature text="15 फ़ोटो गैलरी" />
                          <Feature text="500 शब्दों का विस्तृत विवरण" />
                          <Feature text="🎧 प्राथमिकता सपोर्ट" />
                          <Feature text="📊 विस्तृत एनालिटिक्स" />
                        </>
                      )}
                    </div>
                    ...
                    {/* CTA */}
                    <a
                      href={'https://wa.me/919XXXXXXXXX?text=' + encodeURIComponent('नमस्ते, मुझे ' + plan.name + ' लिस्टिंग प्लान (₹' + (plan.id === 'basic' ? 'Free' : plan.price) + ') चाहिए।')}
                      target="_blank"
                      rel="noopener"
                      className={'flex items-center justify-center gap-2 w-full py-3 text-white font-body font-bold text-[0.88rem] rounded-xl transition-all shadow-md hover:shadow-lg ' + plan.ctaBg}
                    >
                      {plan.cta}
                    </a>
                  </div>
        ...
        {/* Comparison Table */}
        <section className="py-10 md:py-16 px-3 md:px-6 bg-white">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-8">
              <h2 className="font-display text-[clamp(1.3rem,3vw,1.8rem)] font-bold text-stone-900 mb-2">विस्तृत तुलना</h2>
              <p className="font-body text-[0.85rem] text-stone-400">सभी प्लान की सुविधाओं की पूरी तुलना</p>
            </div>
            ...
            <div className="hidden md:block overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr>
                    <th className="text-left py-4 px-4 font-body text-[0.78rem] font-semibold text-stone-500 uppercase tracking-wider border-b-2 border-stone-200 w-[280px]">सुविधा / Feature</th>
                    {plans.map((plan: any) => (
                      <th key={plan.id} className={'text-center py-4 px-3 border-b-2 ' + (plan.popular ? 'border-amber-400 bg-amber-50/50' : 'border-stone-200')}>
                        <div className="flex flex-col items-center gap-1">
                          <span className="text-[1.1rem]">{plan.icon}</span>
                          <span className="font-display text-[0.88rem] font-bold text-stone-800">{plan.name}</span>
                          <span className="font-body text-[0.72rem] font-bold text-red-600">{plan.price}{plan.period}</span>
                        </div>
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {comparisonRows.map((row, i) => (
                    <tr key={row.key} className={i % 2 === 0 ? 'bg-stone-50/50' : 'bg-white'}>
                      <td className="py-3 px-4 border-b border-stone-100">
                        <div className="font-body text-[0.82rem] font-medium text-stone-700">{row.label}</div>
                        <div className="font-body text-[0.65rem] text-stone-400">{row.labelEn}</div>
                      </td>
                      {plans.map((plan: any) => {
                        const val = getFeatureValue(plan.features, row.key, row.type);
                        return (
                          <td key={plan.id} className={'text-center py-3 px-3 border-b border-stone-100 ' + (plan.popular ? 'bg-amber-50/30' : '')}>
                            {row.type === 'boolean' ? (
                              val ? (
                                <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 text-[0.7rem] font-bold">✓</span>
                              ) : (
                                <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-stone-100 text-stone-300 text-[0.7rem]">—</span>
                              )
                            ) : (
                              <span className={'font-body text-[0.78rem] font-semibold ' + (val === '—' ? 'text-stone-300' : 'text-stone-700')}>{val as string}</span>
                            )}
                          </td>
                        );
                      })}
            ...
            <div className="md:hidden space-y-4">
              {plans.map((plan: any) => (
                <div key={plan.id} className={'rounded-xl border-2 overflow-hidden ' + plan.border + (plan.popular ? ' ring-2 ring-amber-400' : '')}>
                  {plan.popular && (
                    <div className="bg-gradient-to-r from-amber-500 to-orange-500 py-1 text-center">
                      <span className="text-[0.62rem] font-bold text-white uppercase tracking-wider">⭐ सबसे लोकप्रिय</span>
                    </div>
                  )}
                  <div className={'bg-gradient-to-b ' + plan.gradient + ' p-4'}>
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <span className="text-[1.2rem]">{plan.icon}</span>
                        <span className="font-display text-[1rem] font-bold text-stone-900">{plan.name}</span>
                      </div>
                      <span className="font-display text-[1.1rem] font-bold text-red-600">{plan.price}<span className="text-[0.7rem] text-stone-400">{plan.period}</span></span>
                    </div>
                    <div className="grid grid-cols-1 gap-1.5">
                      {comparisonRows.map((row) => {
                        ...
                        return (
                          <div key={row.key} className="flex items-center justify-between py-1 border-b border-stone-200/50 last:border-0">
                            <span className={'font-body text-[0.72rem] ' + (isYes ? 'text-stone-700' : 'text-stone-400')}>{row.label}</span>
                            {row.type === 'boolean' ? (
                              isYes ? (
                                <span className="text-[0.7rem] text-green-600 font-bold">✓</span>
                              ) : (
                                <span className="text-[0.7rem] text-stone-300">—</span>
                              )
                            ) : (
                    ...
                    <a href={'https://wa.me/919XXXXXXXXX?text=' + encodeURIComponent('मुझे ' + plan.name + ' प्लान चाहिए।')} target="_blank" rel="noopener" className={'flex items-center justify-center gap-2 w-full py-2.5 mt-4 text-white font-body font-bold text-[0.82rem] rounded-xl ' + plan.ctaBg}>
                      {plan.cta}
                    </a>
                  </div>
                </div>
